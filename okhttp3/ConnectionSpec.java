...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1578deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1580deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1579deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public String toString() {
        if (this.isTls) {
            return "ConnectionSpec(cipherSuites=" + ConnectionSpec$$ExternalSyntheticBackport0.m(cipherSuites(), "[all enabled]") + ", tlsVersions=" + ConnectionSpec$$ExternalSyntheticBackport0.m(tlsVersions(), "[all enabled]") + ", supportsTlsExtensions=" + this.supportsTlsExtensions + ')';
        }
