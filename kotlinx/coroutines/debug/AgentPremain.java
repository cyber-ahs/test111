...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m56constructorimpl = Result.m56constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m56constructorimpl = Result.m56constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = Result.m62isFailureimpl(m56constructorimpl) ? null : m56constructorimpl;
    ...
    public static final void m1516installSignalHandler$lambda1(Signal signal) {
