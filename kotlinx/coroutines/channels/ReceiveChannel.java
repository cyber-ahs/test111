...
public interface ReceiveChannel<E> {
    ...
    Object mo1492receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1493tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1493tryReceivePtdJZtk = receiveChannel.mo1493tryReceivePtdJZtk();
            if (ChannelResult.m1509isSuccessimpl(mo1493tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1505getOrThrowimpl(mo1493tryReceivePtdJZtk);
            }
            Throwable m1503exceptionOrNullimpl = ChannelResult.m1503exceptionOrNullimpl(mo1493tryReceivePtdJZtk);
            if (m1503exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1503exceptionOrNullimpl);
        }
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            int i;
            Object mo1492receiveCatchingJP2dKIU;
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1492receiveCatchingJP2dKIU = receiveChannel.mo1492receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                        if (mo1492receiveCatchingJP2dKIU == coroutine_suspended) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo1492receiveCatchingJP2dKIU = ((ChannelResult) obj).m1511unboximpl();
                    }
                    return ChannelResult.m1504getOrNullimpl(mo1492receiveCatchingJP2dKIU);
                }
            }
