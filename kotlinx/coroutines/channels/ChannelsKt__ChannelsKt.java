...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object mo1494trySendJP2dKIU = sendChannel.mo1494trySendJP2dKIU(e);
        if (!(mo1494trySendJP2dKIU instanceof ChannelResult.Failed)) {
            Unit unit = (Unit) mo1494trySendJP2dKIU;
            return ChannelResult.Companion.m1514successJP2dKIU(Unit.INSTANCE);
        }
        return ((ChannelResult) BuildersKt.runBlocking$default(null, new ChannelsKt__ChannelsKt$trySendBlocking$2(sendChannel, e, null), 1, null)).m1511unboximpl();
    }
    ...
    public static final <E> void sendBlocking(SendChannel<? super E> sendChannel, E e) {
        if (ChannelResult.m1509isSuccessimpl(sendChannel.mo1494trySendJP2dKIU(e))) {
            return;
        }
