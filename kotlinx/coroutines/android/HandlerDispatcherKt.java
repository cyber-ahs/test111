...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            m56constructorimpl = Result.m56constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), null, 2, null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            m56constructorimpl = Result.m56constructorimpl(ResultKt.createFailure(th));
        }
        Main = Result.m62isFailureimpl(m56constructorimpl) ? null : m56constructorimpl;
    }
    ...
    public static final void postFrameCallback(Choreographer choreographer2, final CancellableContinuation<? super Long> cancellableContinuation) {
        choreographer2.postFrameCallback(new Choreographer.FrameCallback() { // from class: kotlinx.coroutines.android.HandlerDispatcherKt$$ExternalSyntheticLambda0
            ...
            public final void doFrame(long j) {
                HandlerDispatcherKt.m1490postFrameCallback$lambda6(CancellableContinuation.this, j);
            }
        });
    }
    ...
    public static final void m1490postFrameCallback$lambda6(CancellableContinuation cancellableContinuation, long j) {
