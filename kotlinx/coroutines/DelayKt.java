...
public final class DelayKt {
    ...
    */
    ...
    public static final Object m1476delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1477toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1477toDelayMillisLRDsOJo(long j) {
        if (Duration.m1339compareToLRDsOJo(j, Duration.Companion.m1442getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1358getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
