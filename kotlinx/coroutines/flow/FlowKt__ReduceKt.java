        ...
        if (continuation instanceof FlowKt__ReduceKt$single$1) {
            ...
            if ((flowKt__ReduceKt$single$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (flow.collect(new FlowKt__ReduceKt$single$2<>(objectRef2), flowKt__ReduceKt$single$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    objectRef = objectRef2;
                } else if (i != 1) {
        ...
        if (continuation instanceof FlowKt__ReduceKt$last$1) {
            ...
            if ((flowKt__ReduceKt$last$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (flow.collect(new FlowKt__ReduceKt$last$2<>(objectRef2), flowKt__ReduceKt$last$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    objectRef = objectRef2;
                } else if (i != 1) {
        ...
        if (continuation instanceof FlowKt__ReduceKt$lastOrNull$1) {
            ...
            if ((flowKt__ReduceKt$lastOrNull$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (flow.collect(new FlowKt__ReduceKt$lastOrNull$2<>(objectRef2), flowKt__ReduceKt$lastOrNull$1) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                    objectRef = objectRef2;
                } else if (i != 1) {
