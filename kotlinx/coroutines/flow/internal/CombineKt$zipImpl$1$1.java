                ...
                */
                public final Object invokeSuspend(Object obj) {
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo1492receiveCatchingJP2dKIU = this.$second.mo1492receiveCatchingJP2dKIU(this);
                    ...
                    if (mo1492receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m1503exceptionOrNullimpl = ChannelResult.m1503exceptionOrNullimpl(mo1492receiveCatchingJP2dKIU);
                    ...
                    T1 t1 = this.$value;
                    if (mo1492receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo1492receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector2;
                    this.label = 2;
                    obj = function3.invoke(t1, mo1492receiveCatchingJP2dKIU, this);
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            if (ChannelFlowKt.withContextUndispatched(this.$scopeContext, Unit.INSTANCE, this.$cnt, new C00091(this.$second, this.$this_unsafeFlow, this.$transform, t1, null), combineKt$zipImpl$1$1$2$1$emit$1) == coroutine_suspended) {
                                return coroutine_suspended;
                            }
                        } else if (i != 1) {
                            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
