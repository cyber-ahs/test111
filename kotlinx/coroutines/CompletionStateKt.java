...
public final class CompletionStateKt {
    ...
    public static final <T> Object toState(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        return new CompletedExceptionally(m59exceptionOrNullimpl, false, 2, null);
    }
        ...
        if (m59exceptionOrNullimpl != null) {
            if (DebugKt.getRECOVER_STACK_TRACES()) {
                ...
                if (cancellableContinuation2 instanceof CoroutineStackFrame) {
                    m59exceptionOrNullimpl = StackTraceRecoveryKt.recoverFromStackFrame(m59exceptionOrNullimpl, (CoroutineStackFrame) cancellableContinuation2);
                }
            }
    ...
    public static final <T> Object recoverResult(Object obj, Continuation<? super T> continuation) {
        if (obj instanceof CompletedExceptionally) {
            ...
            return Result.m56constructorimpl(ResultKt.createFailure(th));
        }
