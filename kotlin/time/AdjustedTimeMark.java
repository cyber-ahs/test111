...
final class AdjustedTimeMark extends TimeMark {
    ...
    public long mo1333elapsedNowUwyO8pc() {
        return Duration.m1375minusLRDsOJo(this.mark.mo1333elapsedNowUwyO8pc(), m1335getAdjustmentUwyO8pc());
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1334plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1376plusLRDsOJo(m1335getAdjustmentUwyO8pc(), j), null);
    }
}
