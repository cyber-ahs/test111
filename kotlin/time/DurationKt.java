...
public final class DurationKt {
    ...
    private static final long m1466timesmvk6XK0(int i, long j) {
        return Duration.m1378timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1465timeskIfJnKk(double d, long j) {
        return Duration.m1377timesUwyO8pc(j, d);
    }

    /* JADX WARN: Removed duplicated region for block: B:249:0x009a A[LOOP:1: B:234:0x006c->B:249:0x009a, LOOP_END] */
    /* JADX WARN: Removed duplicated region for block: B:382:0x00a6 A[EDGE_INSN: B:382:0x00a6->B:251:0x00a6 ?: BREAK  , SYNTHETIC] */
    /*
    ...
    */
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1442getZEROUwyO8pc = Duration.Companion.m1442getZEROUwyO8pc();
        ...
        if (str.charAt(i) == 'P') {
                ...
                if (str.charAt(i2) != 'T') {
                    ...
                    while (true) {
                        ...
                        if (!(c2 <= charAt2 && charAt2 < c)) {
                            z3 = z6;
                            if (!StringsKt.contains$default((CharSequence) "+-.", charAt2, false, 2, obj)) {
                                z4 = false;
                                if (z4) {
                                    break;
                                }
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        long m1376plusLRDsOJo = Duration.m1376plusLRDsOJo(m1442getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1442getZEROUwyO8pc = Duration.m1376plusLRDsOJo(m1376plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        m1442getZEROUwyO8pc = Duration.m1376plusLRDsOJo(m1442getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
            ...
            if (StringsKt.regionMatches(str, i, "Infinity", 0, Math.max(length - i, 8), true)) {
                m1442getZEROUwyO8pc = Duration.Companion.m1440getINFINITEUwyO8pc();
            } else {
                boolean z8 = !z5;
                ...
                while (i < length) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1376plusLRDsOJo2 = Duration.m1376plusLRDsOJo(m1442getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1442getZEROUwyO8pc = Duration.m1376plusLRDsOJo(m1376plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        if (i < length) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        m1442getZEROUwyO8pc = Duration.m1376plusLRDsOJo(m1442getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                    }
        ...
        return z2 ? Duration.m1392unaryMinusUwyO8pc(m1442getZEROUwyO8pc) : m1442getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1340constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1340constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1340constructorimpl((j << 1) + i);
    }
