...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1470copyRFiDyg4$default(TimedValue timedValue, Object obj, long j, int i, Object obj2) {
        if ((i & 1) != 0) {
        ...
        return timedValue.m1472copyRFiDyg4(obj, j);
    }
    ...
    public final TimedValue<T> m1472copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof TimedValue) {
            ...
            return Intrinsics.areEqual(this.value, timedValue.value) && Duration.m1345equalsimpl0(this.duration, timedValue.duration);
        }
        return false;
    }
    ...
    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m1368hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + ((Object) Duration.m1389toStringimpl(this.duration)) + ')';
    }
