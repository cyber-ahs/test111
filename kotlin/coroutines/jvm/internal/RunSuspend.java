...
final class RunSuspend implements Continuation<Unit> {
    ...
    public void resumeWith(Object obj) {
        synchronized (this) {
            this.result = Result.m55boximpl(obj);
            notifyAll();
    ...
    public final void await() {
        synchronized (this) {
            while (true) {
                Result<Unit> m1243getResultxLWZpok = m1243getResultxLWZpok();
                if (m1243getResultxLWZpok == null) {
                    wait();
                } else {
                    ResultKt.throwOnFailure(m1243getResultxLWZpok.m65unboximpl());
                }
            }
        }
    }
