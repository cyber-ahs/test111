...
public final class ULongArrayKt {
    ...
    private static final long[] m298ulongArrayOfQwZRm1k(long... elements) {
    ...
    private static final long[] ULongArray(int i, Function1<? super Integer, ULong> init) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = init.invoke(Integer.valueOf(i2)).m279unboximpl();
        }
        return ULongArray.m282constructorimpl(jArr);
    }
}
