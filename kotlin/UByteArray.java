...
public final class UByteArray implements Collection<UByte>, KMappedMarker {
    ...
    public static final /* synthetic */ UByteArray m124boximpl(byte[] bArr) {
        return new UByteArray(bArr);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static byte[] m126constructorimpl(byte[] storage) {
    ...
    public static final byte m131getw2LRezQ(byte[] bArr, int i) {
        return UByte.m74constructorimpl(bArr[i]);
    }
    ...
    public static java.util.Iterator<UByte> m135iteratorimpl(byte[] bArr) {
    ...
    public static final class Iterator extends UByteIterator {
        ...
        public byte mo141nextUBytew2LRezQ() {
            int i = this.index;
    ...
    public boolean containsAll(Collection<? extends Object> elements) {
        ...
        return m128containsAllimpl(this.storage, elements);
    }

    /* renamed from: containsAll-impl  reason: not valid java name */
    public static boolean m128containsAllimpl(byte[] bArr, Collection<UByte> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UByte> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UByte) && ArraysKt.contains(bArr, ((UByte) obj).m123unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
