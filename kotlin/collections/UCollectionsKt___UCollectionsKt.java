...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] m125constructorimpl = UByteArray.m125constructorimpl(collection.size());
        int i = 0;
        for (UByte uByte : collection) {
            UByteArray.m136setVurrAj0(m125constructorimpl, i, uByte.m123unboximpl());
            i++;
        }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] m203constructorimpl = UIntArray.m203constructorimpl(collection.size());
        int i = 0;
        for (UInt uInt : collection) {
            UIntArray.m214setVXSXFK8(m203constructorimpl, i, uInt.m201unboximpl());
            i++;
        }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        for (ULong uLong : collection) {
            ULongArray.m292setk8EXiF4(m281constructorimpl, i, uLong.m279unboximpl());
            i++;
        }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] m385constructorimpl = UShortArray.m385constructorimpl(collection.size());
        int i = 0;
        for (UShort uShort : collection) {
            UShortArray.m396set01HTLdE(m385constructorimpl, i, uShort.m383unboximpl());
            i++;
        }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt uInt : iterable) {
            i = UInt.m150constructorimpl(i + uInt.m201unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong uLong : iterable) {
            j = ULong.m228constructorimpl(j + uLong.m279unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte uByte : iterable) {
            i = UInt.m150constructorimpl(i + UInt.m150constructorimpl(uByte.m123unboximpl() & UByte.MAX_VALUE));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort uShort : iterable) {
            i = UInt.m150constructorimpl(i + UInt.m150constructorimpl(uShort.m383unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
