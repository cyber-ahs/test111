    ...
    private static class EasingFunctions {
        ...
        public static final EasingFunction EaseInElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.20
            ...
            public float getInterpolation(float f) {
                ...
                double asin = (f - 1.0f) - (0.047746483f * ((float) Math.asin(1.0d)));
                Double.isNaN(asin);
                double d = 0.3f;
                Double.isNaN(d);
                return -(((float) Math.pow(2.0d, 10.0f * f2)) * ((float) Math.sin((asin * 6.283185307179586d) / d)));
            }
        };
        public static final EasingFunction EaseOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.21
            ...
            public float getInterpolation(float f) {
                ...
                double asin = f - (0.047746483f * ((float) Math.asin(1.0d)));
                Double.isNaN(asin);
                double d = 0.3f;
                Double.isNaN(d);
                return (((float) Math.pow(2.0d, (-10.0f) * f)) * ((float) Math.sin((asin * 6.283185307179586d) / d))) + 1.0f;
            }
        };
        public static final EasingFunction EaseInOutElastic = new EasingFunction() { // from class: com.github.mikephil.charting.animation.Easing.EasingFunctions.22
            ...
            public float getInterpolation(float f) {
                ...
                if (f4 < 1.0f) {
                    double d = ((f4 - 1.0f) * 1.0f) - asin;
                    Double.isNaN(d);
                    double d2 = 0.45000002f;
                    Double.isNaN(d2);
                    return ((float) Math.pow(2.0d, 10.0f * f3)) * ((float) Math.sin((d * 6.283185307179586d) / d2)) * (-0.5f);
                }
                double d3 = ((f4 - 1.0f) * 1.0f) - asin;
                Double.isNaN(d3);
                double d4 = 0.45000002f;
                Double.isNaN(d4);
                return (((float) Math.pow(2.0d, (-10.0f) * f2)) * ((float) Math.sin((d3 * 6.283185307179586d) / d4)) * 0.5f) + 1.0f;
            }
        };
