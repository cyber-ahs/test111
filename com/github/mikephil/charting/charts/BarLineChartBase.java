...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> extends Chart<T> implements BarLineScatterCandleBubbleDataProvider {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mAutoScaleMinMaxEnabled) {
            ...
            Float f2 = this.mAutoScaleLastLowestVisibleXIndex;
            if (f2 == null || f2.floatValue() != lowestVisibleX || (f = this.mAutoScaleLastHighestVisibleXIndex) == null || f.floatValue() != highestVisibleX) {
                calcMinMax();
                calculateOffsets();
                this.mAutoScaleLastLowestVisibleXIndex = Float.valueOf(lowestVisibleX);
                this.mAutoScaleLastHighestVisibleXIndex = Float.valueOf(highestVisibleX);
            }
        }
    ...
    public void setVisibleYRangeMinimum(float f, YAxis.AxisDependency axisDependency) {
        this.mViewPortHandler.setMaximumScaleY(getDeltaY(axisDependency) / f);
    }

    public void setVisibleYRange(float f, float f2, YAxis.AxisDependency axisDependency) {
        this.mViewPortHandler.setMinMaxScaleY(getDeltaY(axisDependency) / f, getDeltaY(axisDependency) / f2);
    }
    ...
    public void moveViewTo(float f, float f2, YAxis.AxisDependency axisDependency) {
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, f, f2 + ((getDeltaY(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this));
    }

    public void moveViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        if (Build.VERSION.SDK_INT >= 11) {
            MPPointD valuesByTouchPoint = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axisDependency);
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f, f2 + ((getDeltaY(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.x, (float) valuesByTouchPoint.y, j));
            MPPointD.recycleInstance(valuesByTouchPoint);
            return;
        }
    ...
    public void centerViewToY(float f, YAxis.AxisDependency axisDependency) {
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, 0.0f, f + ((getDeltaY(axisDependency) / this.mViewPortHandler.getScaleY()) / 2.0f), getTransformer(axisDependency), this));
    }
    ...
    public void centerViewTo(float f, float f2, YAxis.AxisDependency axisDependency) {
        ...
        addViewportJob(MoveViewJob.getInstance(this.mViewPortHandler, f - ((getXAxis().mAxisRange / this.mViewPortHandler.getScaleX()) / 2.0f), f2 + (deltaY / 2.0f), getTransformer(axisDependency), this));
    }
    ...
    public void centerViewToAnimated(float f, float f2, YAxis.AxisDependency axisDependency, long j) {
        if (Build.VERSION.SDK_INT >= 11) {
            MPPointD valuesByTouchPoint = getValuesByTouchPoint(this.mViewPortHandler.contentLeft(), this.mViewPortHandler.contentTop(), axisDependency);
            float deltaY = getDeltaY(axisDependency) / this.mViewPortHandler.getScaleY();
            addViewportJob(AnimatedMoveViewJob.getInstance(this.mViewPortHandler, f - ((getXAxis().mAxisRange / this.mViewPortHandler.getScaleX()) / 2.0f), f2 + (deltaY / 2.0f), getTransformer(axisDependency), this, (float) valuesByTouchPoint.x, (float) valuesByTouchPoint.y, j));
            MPPointD.recycleInstance(valuesByTouchPoint);
            return;
        }
    ...
    public MPPointD getPixelsForValues(float f, float f2, YAxis.AxisDependency axisDependency) {
        return getTransformer(axisDependency).getPixelsForValues(f, f2);
    }

    public float getYValueByTouchPoint(float f, float f2, YAxis.AxisDependency axisDependency) {
        getValuesByTouchPoint(f, f2, axisDependency, this.pointForGetYValueByTouchPoint);
