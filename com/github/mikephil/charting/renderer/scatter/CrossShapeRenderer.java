        ...
        for (int i = 0; i < scatterBuffer.size() && viewPortHandler.isInBoundsRight(scatterBuffer.buffer[i]); i += 2) {
            if (viewPortHandler.isInBoundsLeft(scatterBuffer.buffer[i])) {
                ...
                if (viewPortHandler.isInBoundsY(scatterBuffer.buffer[i2])) {
                    ...
                    canvas.drawLine(scatterBuffer.buffer[i] - f2, scatterBuffer.buffer[i2], scatterBuffer.buffer[i] + f2, scatterBuffer.buffer[i2], paint);
                    canvas.drawLine(scatterBuffer.buffer[i], scatterBuffer.buffer[i2] - f2, scatterBuffer.buffer[i], scatterBuffer.buffer[i2] + f2, paint);
                }
            }
        }
    }
