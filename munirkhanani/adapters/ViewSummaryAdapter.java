...
public class ViewSummaryAdapter extends RecyclerView.Adapter<MyMarket> {
    private Context context;
    ViewSummaryModel viewSummaryModel;
    List<ViewSummaryModel> viewSummaryModelList;

    public ViewSummaryAdapter(Context context, List<ViewSummaryModel> list) {
    ...
    public MyMarket onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new MyMarket(layoutInflater != null ? layoutInflater.inflate(R.layout.view_summary_list_item, viewGroup, false) : null);
    }
    ...
    public void onBindViewHolder(MyMarket myMarket, int i) {
        try {
            ...
            myMarket.realizedAmt.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_blue));
            myMarket.expanseAmount.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_gray));
            myMarket.netWorth.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_blue));
