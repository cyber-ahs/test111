...
public class ViewSummaryFourAdapter extends RecyclerView.Adapter<MyMarket> {
    private Context context;
    ViewSummaryModelFour viewSummaryModel;
    List<ViewSummaryModelFour> viewSummaryModelList;

    public ViewSummaryFourAdapter(Context context, List<ViewSummaryModelFour> list) {
    ...
    public MyMarket onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        return new MyMarket(layoutInflater != null ? layoutInflater.inflate(R.layout.view_summary_four_list_item, viewGroup, false) : null);
    }
    ...
    public void onBindViewHolder(MyMarket myMarket, int i) {
        try {
            ...
            myMarket.ledbalan.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_green));
            myMarket.invenMarkval.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_gray_4));
            myMarket.invanSold.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_green));
            myMarket.heldAmt.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_gray_4));
            myMarket.realizedAmt.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_green));
            myMarket.expanseAmount.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_gray_4));
            myMarket.netWorth.setBackgroundColor(this.context.getResources().getColor(R.color.xexpu_sum_green));
            myMarket.realizedAmt.setText("");
            myMarket.expanseAmount.setText("");
            myMarket.netWorth.setText("");
