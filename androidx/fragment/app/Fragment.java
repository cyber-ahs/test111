...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public void performConfigurationChanged(Configuration configuration) {
        ...
        this.mChildFragmentManager.m37lambda$new$0$androidxfragmentappFragmentManager(configuration);
    }
    ...
    public void performSaveInstanceState(Bundle bundle) {
        ...
        Bundle m36lambda$attachController$4$androidxfragmentappFragmentManager = this.mChildFragmentManager.m36lambda$attachController$4$androidxfragmentappFragmentManager();
        if (m36lambda$attachController$4$androidxfragmentappFragmentManager != null) {
            bundle.putParcelable("android:support:fragments", m36lambda$attachController$4$androidxfragmentappFragmentManager);
        }
    }
