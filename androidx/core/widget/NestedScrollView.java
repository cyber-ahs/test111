            ...
            if (axisValue != 0.0f) {
                ...
                if (verticalScrollFactorCompat < 0) {
                    if (canOverScroll() && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                        EdgeEffectCompat.onPullDistance(this.mEdgeGlowTop, (-verticalScrollFactorCompat) / getHeight(), MAX_SCROLL_FACTOR);
                        this.mEdgeGlowTop.onRelease();
                        invalidate();
                        z = 1;
                    }
                    ...
                    if (canOverScroll() && !MotionEventCompat.isFromSource(motionEvent, 8194)) {
                        EdgeEffectCompat.onPullDistance(this.mEdgeGlowBottom, (verticalScrollFactorCompat - scrollRange) / getHeight(), MAX_SCROLL_FACTOR);
                        this.mEdgeGlowBottom.onRelease();
                        invalidate();
                        i = 1;
                    }
